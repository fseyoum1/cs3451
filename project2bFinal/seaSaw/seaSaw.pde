...
void draw () { 
  ...
  //light source
  directionalLight (100, 104, 102, -0.9, -0.7, -1);
  
  directionalLight (150, 150, 152, 0, 0, -20);
  ...
  if (time < 10) {
  camera(100.0, 35.0, 120.0 , 50.0, 50.0, 0.0, 
       0.0, 1.0, 0.0);
    ...
    if(time > 10 && time < 15) {
      //top view of the play
      camera (70.0, 35.0, 120.0, 10, 10, 0, 0,  1, 0); 
    }  else if (time > 14 && time < 21) {
      //side view of the play
      camera (-50, 60, 100, 0, 0, 0, 0,  1, 0);
